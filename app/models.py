...
utilisateur_evenement = db.Table('utilisateur_evenement',
...
class Utilisateur(db.Model):
    ...
    # ⚠️ Association à plusieurs évènements
    evenements = db.relationship('Evenement', secondary=utilisateur_evenement, backref='utilisateurs')
